-- DESAFIO 1
--A)Transformando o bloco anonimo numa stored procedure de nome "PR_SGV_CARGA_RESUMO_OCORR_SAC"
CREATE OR REPLACE PROCEDURE PR_SGV_CARGA_RESUMO_OCORR_SAC IS
/*----------------------------------------------------------------------------------
Objetivo     : Esta procedure tem por objetivo cadastrar todos os chamados
